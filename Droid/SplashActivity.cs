...
{
    [Activity(Label = "GeoMatch", Icon = "@mipmap/i", MainLauncher = true, ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait,
	...
	public class SplashActivity : Activity
	{
        ...
        async void SimulateStartup()
        {
            ...
            StartActivity(new Intent(Application.Context, typeof(Splash2Activity)));
            Finish();
        }
